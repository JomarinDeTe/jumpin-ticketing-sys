...
namespace JumpInTicket
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<JumpInTicketsContext>(options => options.UseSqlServer(Configuration.GetConnectionString("TicketConnection")));
            ...
            {
                options.ConnectionString = Configuration.GetConnectionString("TicketConnection");
            });
